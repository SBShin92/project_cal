            ...
            <tbody>
                <c:forEach var="user" items="${userVOs}">
                    <tr>
                        ...
                        <td>
                            <a href="<c:url value='/manager/users/edit/${user.userId}'/>" class="btn btn-edit">수정</a>
                            <a href="<c:url value='/manager/users/delete/${user.userId}'/>" class="btn btn-delete" onclick="return confirm('정말로 이 사용자를 삭제하시겠습니까?');">삭제</a>
                        </td>
                    </tr>
                </c:forEach>
            </tbody>
