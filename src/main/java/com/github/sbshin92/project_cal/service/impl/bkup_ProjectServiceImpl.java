...
// */
//@Service
//public class ProjectServiceImpl_bkup implements ProjectService {
//
//	
//    // 로깅을 위한 Logger 인스턴스 생성
//    private static final Logger logger = LoggerFactory.getLogger(ProjectServiceImpl_bkup.class);
//	
//    @Autowired
